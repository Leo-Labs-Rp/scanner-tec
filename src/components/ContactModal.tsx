...
export default function ContactModal({ onClose, open }: Props) {
  ...
  return (
    <div className="product-modal" role="dialog" aria-modal="true" aria-label="Fale conosco">
      ...
      <article className="contact-modal">
        ...
        <header>
          <h2>Fale conosco</h2>
          <p>Preencha uma mensagem rápida ou fale diretamente com a equipe pelo WhatsApp.</p>
        </header>
